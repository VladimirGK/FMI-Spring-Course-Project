...
export default class AddBattery extends Component {
    state = {
        name: '',
        brand: '',
        price: '',
    ...
    handleSubmit = event => {
        ...
        axios.post(`http://localhost:8080/api/battery`, item, { headers })
            .then(res => {
                console.log(res);
        ...
        return (
            <div>
                <div class="alert alert-info alert-dismissible fade show" style={{marginTop: "20px"}}>
                    <strong>Добави нов акумолатор в магазина</strong>
                </div>
